const villians = [
  ...
  },
  {
    ...
    idx: 0,
    audio: ["./auds/blo2.m4a", "./auds/tracy.m4a", "./auds/bsecret.m4a"]
  },
  {
  ...
  },
  {
    ...
    idx: 0,
    audio: ["./auds/mrbig.m4a", "./auds/sol.m4a", "./auds/rosie.m4a", "./auds/caruso.m4a", "./auds/blive.m4a"]
  },
  {
    ...
    idx: 0,
    audio: ["./auds/scar.m4a", "./auds/mary.m4a", "./auds/andrea.m4a", "./auds/bgolden.m4a"]
  },
  {
    ...
    idx: 0,
    audio: ["./auds/strom.m4a", "./auds/anya.m4a", "./auds/naomi.m4a", "./auds/felicca.m4a", "./auds/bspy.m4a"]
  },
  {
    name: ["Hugo Drax", "Corinne Dufour", "Dr. Holly Goodhead", "Moonraker"],
    movie: "Moonraker",
    fate: ["was shot with poison dart gun and ejected into outer space, by Bond. ",
            "was Hugo Drax's personal assistant and pilot. She flew Bond over Drax's estate, giving him a guided tour of the Moonraker complex and flying him to meet Drax. After spending the night with Bond, Corinne revealed the location of Drax's safe, where Bond photographed secret documents. Drax discovered this, and Corinne was killed by Drax's vicious pack of dogs.", "was a CIA agent working undercover as an astronaut for the Hugo Drax organization. After spending the night together with Bond, the two met up at the top of Sugarloaf mountain in Rio. On the cable car ride down, Jaws tried to kill them, and Holly's cover was blown.", "follows clues that lead him first to Venice, where he discovers Drax’s laboratory manufacturing a highly toxic nerve gas, and then to Rio, where he teams up with CIA agent and astrophysicist Holly Goodhead."],
    pic:  ["url(./pics/drax.jpg)", "url(./pics/corinne.jpg)", "url(./pics/holly.jpg)", "url(./pics/bmoon.jpg)"],
    idx: 0,
    audio: ["./auds/drax.m4a", "./auds/corinne.m4a", "./auds/holly.m4a", "./auds/bmoon.m4a"]
  },
  {
    name: ["Aristotle Kristatos", "Melina Havelock",  "Bibi Dahl", "For Your Eyes Only"],
    movie: "For Your Eyes Only",
    fate: ["was killed with a knife thrown by Milos Columbo. ",
            "was the daughter of two marine explorers who did salvage work for the British Secret Service. After her parents were assassinated by henchman Hector Gonzales, Melina found the hitman and killed him with a crossbow.", "was a young ice skater sponsored by double agent Kristatos. Bibi was very attracted to Bond, however he turned her down on every occasion due to her young age.", "is ordered to retrieve the Automatic Targeting Attack Communicator (ATAC), housed on a sunken spy ship, the St. Georges. When Sir Timothy Havelock, a marine archaeologist secretly helping the British to locate the ship, is murdered along with his wife, Bond is dispatched to Spain to find out who hired the hitman, Gonzales, but before he can find out, Gonzales is killed by Havelock’s daughter, Melina."],
    pic:  ["url(./pics/ari.jpg)", "url(./pics/melina.jpg)", "url(./pics/bibi.jpg)", "url(./pics/beyes.jpg)"],
    idx: 0,
    audio: ["./auds/ari.m4a", "./auds/melina.m4a", "./auds/bibi.m4a", "./auds/beyes.m4a"]
  },
  {
    name: ["Kamal Khan", "Octopussy", "Magda", "Octopussy"],
    movie: "Octopussy",
    fate: ["dies when his plane crashes into a mountain.",
          "ran an all-women floating island, the girls of which were acrobats for a circus that was a front for a jewellery smuggling operation. She was a partner in crime with Kamal Khan, who stole the jewellery for himself and tried to kill Octopussy.", "was the right-hand woman of Octopussy, and assisted her smuggling partner Kamal Khan on many occasions throughout the film. After attending an auction in which Bond stole a Fabegé egg, Magda was sent to sleep with Bond so that she could steal it back.","swaps a real Faberge egg with a fake, and drives up the bidding against exiled Afghan prince Kamal Khan, who ultimately wins the auction. Bond follows Khan back to his palace in Rajasthan, India, where he discovers that Khan is working with Orlov, a renegade Soviet general, and is using Octopussy’s circus troupe to smuggle Soviet treasures into the West."],
    pic:  ["url(./pics/khan.jpg)", "url(./pics/octo.jpg)", "url(./pics/magda.jpg)", "url(./pics/bocto.jpg)"],
    idx: 0,
    audio: ["./auds/kamal.m4a", "./auds/octo.m4a", "./auds/magda.m4a", "./auds/bocto.m4a"]
  },
  {
    name: ["Max Zorin", "Stacey Sutton", "MayDay", "Pola Ivanova", "A View to a Kill"],
    movie: "A View to a Kill",
    fate: ["falls to his death from the top of the Golden Gate Bridge after a fight with Bond.",
          "inherited the Sutton Oil company, which megalomaniac Max Zorin tried to take over. Zorin offered Sutton $5 million for her shares in the company, which she refused.", "maydays fate", "was a KGB agent working for General Gogol. She recorded incriminating evidence of Max Zorin, and escaped with a tape of it. Bond had followed her, and a struggle ensued, until they both realized that they knew one another from a prior mission.", "recovers a microchip from the body of 003 in Siberia which is a copy of one that is impervious to the magnetic pulse of a nuclear blast. It is made by a company recently acquired by Anglo-French combine Zorin Industries, so Bond is assigned to investigate Max Zorin."],
    pic:  ["url(./pics/zorin.jpg)", "url(./pics/stacey.jpg)", "url(./pics/mayday.jpg)", "url(./pics/pola.jpg)", "url(./pics/bview.png)"],
    idx: 0,
    audio: ["./auds/zorin.m4a", "./auds/stacey.m4a", "./auds/mayday.m4a", "./auds/pola.m4a", "./auds/bview.m4a"]
  },
  {
    ...
    idx: 0,
    audio: ["./auds/georgi.m4a", "./auds/kara.m4a", "./auds/bliving.m4a"]
  }
];
